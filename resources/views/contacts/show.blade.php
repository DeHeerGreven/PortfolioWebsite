        ...
        <div class="container">
          <div class="text-center">
            ...
            <p>Neem contact met mij op!</p>
             <form action="{{ route('contact.submit')}}" method="POST" enctype="multipart/form-data" class="flex flex-col items-center">
                @csrf
                <div class="mb-4">
                ...
                <div class="mb-4">
                  ...
                  <textarea name="content" class="border border-gray-300 p-2 rounded-md w-full"></textarea>
                </div>
